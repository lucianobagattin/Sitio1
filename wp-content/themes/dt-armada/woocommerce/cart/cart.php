			...
			<td colspan="6" class="actions">
				...
				<?php if ( wc_coupons_enabled() ) { ?>
					<div class="coupon">
						...
						<label for="coupon_code"><?php _e( 'Coupon', LANGUAGE_ZONE ); ?>:</label> <input type="text" name="coupon_code" class="input-text" id="coupon_code" value="" placeholder="<?php _e( 'Coupon code', LANGUAGE_ZONE ); ?>" /> <input type="submit" class="button" name="apply_coupon" value="<?php _e( 'Apply Coupon', LANGUAGE_ZONE ); ?>" />
				...
				<input type="submit" class="button" name="update_cart" value="<?php _e( 'Update Cart', LANGUAGE_ZONE ); ?>" />
