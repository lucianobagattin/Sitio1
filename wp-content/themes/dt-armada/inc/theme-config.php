...
if ( ! function_exists( 'presscore_congif_populate_single_album_vars' ) ) :
	...
	function presscore_congif_populate_single_album_vars() {
		...
		if ( 'photo_scroller' == $post_media_type ) {
...
if ( ! function_exists( 'presscore_config_populate_header_options' ) ) :
	...
	function presscore_config_populate_header_options() {
		...
		$config->set( 'header.background.fixed', of_get_option( 'header-bg_fixed', false ) );
		...
		if ( 'side' != $header_layout ) {
			...
			switch ( $header_title ) {
				...
				case 'slideshow':
					...
					$config->set( 'header.transparent.background.opacity', get_post_meta( $post_id, "{$prefix}transparent_bg_opacity", true ) );
					$config->set( 'header.transparent.background.color', get_post_meta( $post_id, "{$prefix}transparent_bg_color", true ) );
					$config->set( 'header.transparent.background.style', get_post_meta( $post_id, "{$prefix}transparent_bg_style", true ), 'solid_background' );

					$config->set( 'header.transparent.menu_text.color.mode', get_post_meta( $post_id, "{$prefix}transparent_menu_text_color_mode", true ), 'theme' );
					$config->set( 'header.transparent.menu_decoration.color.mode', get_post_meta( $post_id, "{$prefix}transparent_menu_hover_color_mode", true ), 'theme' );
					$config->set( 'header.transparent.top_bar.color.mode', get_post_meta( $post_id, "{$prefix}transparent_menu_top_bar_color_mode", true ), 'theme' );
					break;
				...
				default:
					...
					$config->set( 'header.transparent.background.opacity', of_get_option( 'header-transparent_bg_opacity', 100 ) );
					$config->set( 'header.transparent.background.color', of_get_option( 'header-transparent_bg_color', '#ffffff' ) );
					$config->set( 'header.transparent.background.style', of_get_option( 'header-style', 'solid_background' ) );

					$config->set( 'header.transparent.menu_text.color.mode', of_get_option( 'header-menu_text_color_mode', 'theme' ) );
					$config->set( 'header.transparent.menu_decoration.color.mode', of_get_option( 'header-menu_hover_color_mode', 'theme' ) );
					$config->set( 'header.transparent.top_bar.color.mode', of_get_option( 'header-menu_top_bar_color_mode', 'theme' ) );
					break;
			}
		...
		$config->set( 'fancy_header.title.aligment', get_post_meta( $post_id, "{$prefix}title_aligment", true ) );
		$config->set( 'fancy_header.title.font.size', get_post_meta( $post_id, "{$prefix}title_size", true ) );
		$config->set( 'fancy_header.title.color.mode', get_post_meta( $post_id, "{$prefix}title_color_mode", true ) );
		$config->set( 'fancy_header.title.color', get_post_meta( $post_id, "{$prefix}title_color", true ) );

		// subtitle

		$config->set( 'fancy_header.subtitle', get_post_meta( $post_id, "{$prefix}subtitle", true ) );
		$config->set( 'fancy_header.subtitle.font.size', get_post_meta( $post_id, "{$prefix}subtitle_size", true ) );
		$config->set( 'fancy_header.subtitle.color.mode', get_post_meta( $post_id, "{$prefix}subtitle_color_mode", true ) );
		$config->set( 'fancy_header.subtitle.color', get_post_meta( $post_id, "{$prefix}subtitle_color", true ) );
...
if ( ! function_exists( 'presscore_config_populate_sidebar_and_footer_options' ) ) :
	...
	function presscore_config_populate_sidebar_and_footer_options() {
		...
		// Footer options
		$prefix = '_dt_footer_';
		$config->set( 'footer_show', get_post_meta( $post_id, "{$prefix}show", true ) );
