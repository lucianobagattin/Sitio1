...
if ( ! function_exists( 'presscore_get_dynamic_stylesheets_list' ) ) :
	...
	function presscore_get_dynamic_stylesheets_list() {
		...
		if ( null === $dynamic_stylesheets ) {
			...
			$dynamic_stylesheets['dt-main.less'] = array(
				'path' => $template_directory . '/css/main.less',
				'src' => $template_uri . '/css/main.less',
				'fallback_src' => $template_uri . '/css/compiled/main-%preset%.css',
				'deps' => array(),
				'ver' => $theme_version,
				'media' => 'all'
			);
