...
/* Load the widget */
add_action( 'widgets_init', array( 'Presscore_Inc_Widgets_TestimonialsSlider', 'presscore_register_widget' ) );

class Presscore_Inc_Widgets_TestimonialsSlider extends WP_Widget {
	...
	function __construct() {  
		/* Widget settings. */
		$widget_ops = array( 'description' => _x( 'Testimonials slider', 'widget', LANGUAGE_ZONE ) );

		/* Create the widget. */
		parent::__construct(
			'presscore-testimonials-slider',
			DT_WIDGET_PREFIX . _x( 'Testimonials slider', 'widget', LANGUAGE_ZONE ),
			$widget_ops
		);
	}
