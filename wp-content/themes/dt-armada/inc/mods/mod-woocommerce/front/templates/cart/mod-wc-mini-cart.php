...
<div class="shopping-cart">
	...
	<a class="wc-ico-cart<?php echo $dt_cart_class; ?>" href="<?php echo wc_get_cart_url(); ?>"><?php echo $dt_cart_caption; ?><span<?php echo $dt_cart_counter_bg_class; ?>><?php echo $dt_products_count; ?></span></a>
	...
	<div class="shopping-cart-wrap">
		<div class="shopping-cart-inner">
				...
				<?php if ( !$cart_is_empty ) : ?>
					...
					<?php foreach ( WC()->cart->get_cart() as $cart_item_key => $cart_item ) :
						...
						if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_widget_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
							...
							?>
							<li>
								<?php echo apply_filters( 'woocommerce_cart_item_remove_link', sprintf( '<a href="%s" class="remove" title="%s">&times;</a>', esc_url( WC()->cart->get_remove_url( $cart_item_key ) ), __( 'Remove this item', LANGUAGE_ZONE ) ), $cart_item_key ); ?>
			...
			<?php endif; ?>
				...
				<p class="buttons">
					<a href="<?php echo wc_get_cart_url(); ?>" class="button view-cart"><?php _e( 'View Cart', LANGUAGE_ZONE ); ?></a>
					<a href="<?php echo wc_get_checkout_url(); ?>" class="button checkout"><?php _e( 'Checkout', LANGUAGE_ZONE ); ?></a>
				</p>
