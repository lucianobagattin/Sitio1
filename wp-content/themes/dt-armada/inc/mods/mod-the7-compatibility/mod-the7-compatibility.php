				...
				$msg = '<p>' 
					...
					. '<div class="dt-buttons-holder">' 
						. '<div class="dt-button-secondary">' 
							. '<a href="' . esc_url( $dismiss_link ) . '" class="button button-secondary">' . _x( "Dismiss this message" , 'options import', LANGUAGE_ZONE ) . '</a>' 
						. '</div>' 
						. '<div class="dt-button-primary">' 
							. '<a href="' . esc_url( $import_link ) . '" class="button button-primary dt-import-options">' . _x( "Yes, do it!" , 'options import', LANGUAGE_ZONE ) . '</a>' 
