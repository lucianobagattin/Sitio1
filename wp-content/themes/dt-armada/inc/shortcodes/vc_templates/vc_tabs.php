...
if ( 'vc_tour' === $this->shortcode ) {
	$next_prev_nav = '<div class="wpb_tour_next_prev_nav vc_clearfix"> <span class="wpb_prev_slide"><a href="#prev" title="' . __( 'Previous tab', LANGUAGE_ZONE ) . '">' . __( 'Previous tab', LANGUAGE_ZONE ) . '</a></span> <span class="wpb_next_slide"><a href="#next" title="' . __( 'Next tab', LANGUAGE_ZONE ) . '">' . __( 'Next tab', LANGUAGE_ZONE ) . '</a></span></div>';
} else {
	$next_prev_nav = '';
}
