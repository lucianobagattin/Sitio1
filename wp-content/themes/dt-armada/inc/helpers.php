...
if ( ! function_exists( 'presscore_get_post_fancy_date' ) ) :
	...
	function presscore_get_post_fancy_date( $new_class = '' ) {
		...
		return sprintf(
			'<div class="%s"><a title="%s" href="%s" rel="nofollow"><span class="entry-month">%s</span><span class="entry-date">%s</span><span class="entry-year">%s</span></a></div>',
...
if ( ! function_exists( 'presscore_get_categorizer_sorting_fields' ) ) :
	...
	function presscore_get_categorizer_sorting_fields() {
		...
		$html .= '<div class="filter-by"' . ( $show_orderby ? '' : $display_none ) . '>' . "\n";
		$html .= '<a href="' . esc_url( add_query_arg( array( 'orderby' => 'date', 'order' => $order ), $link ) ) . '" class="sort-by-date' . ('date' == $orderby ? $act : '') . '" data-by="date"></a>' . "\n";
		$html .= '<a href="' . esc_url( add_query_arg( array( 'orderby' => 'name', 'order' => $order ), $link ) ) . '" class="sort-by-name' . ('name' == $orderby ? $act : '') . '" data-by="name"></a>' . "\n";
		$html .= '</div>' . "\n";
		...
		$html .= '<div class="filter-sorting"' . ( $show_order ? '' : $display_none ) . '>' . "\n";
		$html .= '<a href="' . esc_url( add_query_arg( array( 'orderby' => $orderby, 'order' => 'DESC' ), $link ) ) . '" class="sort-by-desc' . ('DESC' == $order ? $act : '') . '" data-sort="desc"></a>';
		$html .= '<a href="' . esc_url( add_query_arg( array( 'orderby' => $orderby, 'order' => 'ASC' ), $link ) ) . '" class="sort-by-asc' . ('ASC' == $order ? $act : '') . '" data-sort="asc"></a>';
		$html .= '</div>' . "\n";
