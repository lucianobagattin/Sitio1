...
$options[] = array(	"name" => _x('Logo in header', 'theme-options', LANGUAGE_ZONE), "type" => "block_begin" );
	...
	$options["header-logo_padding_top"] = array(
		"name"		=> _x( "Padding top", "theme-options", LANGUAGE_ZONE ),
	...
	$options["header-logo_padding_bottom"] = array(
		"name"		=> _x( "Padding bottom", "theme-options", LANGUAGE_ZONE ),
...
$options[] = array(	"name" => _x('Favicon', 'theme-options', LANGUAGE_ZONE), "type" => "block_begin" );
	...
	// uploader
	$options[] = array(
		"name"	=> _x( 'High-DPI (32x32 px)', 'theme-options', LANGUAGE_ZONE ),
