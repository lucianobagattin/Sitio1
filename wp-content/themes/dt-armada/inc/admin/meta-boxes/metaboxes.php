...
$DT_META_BOXES['dt_page_box-slideshow_options'] = array(
	...
	'fields' 	=> array(
		...
		array(
			...
			'desc'  		=> _x('if non selected, all slideshows will be displayed.', 'backend metabox', LANGUAGE_ZONE) . ' <a href="' . esc_url( add_query_arg( 'post_type', 'dt_slideshow', get_admin_url() . 'edit.php' ) ) . '" target="_blank">' . _x('Edit slideshows', 'backend metabox', LANGUAGE_ZONE) . '</a>',
