...
function presscore_new_themeoptions_to_less( $options_inteface = array() ) {
	...
	$options_inteface[] = array(
		...
		'php_vars'	=> array(
			'color' 	=> array( 'header-transparent_bg_color', '#ffffff' ),
			'opacity'	=> array( 'header-transparent_bg_opacity', 100 ),
		),
	);
...
function presscore_new_compilled_less_special_cases( $options = array() ) {
	...
	$options['widget-sidebar-bg-color'] = 'rgba(255, 255, 255, 1)';
	$options['widget-sidebar-bg-color-ie'] = '#fff';
	$options['widget-sidebar-bg-image'] = '~""';
	$options['widget-sidebar-bg-repeat'] = 'repeat';
	$options['widget-sidebar-bg-position-x'] = 'left';
	$options['widget-sidebar-bg-position-y'] = 'top';
