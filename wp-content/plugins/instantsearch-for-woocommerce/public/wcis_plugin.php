...
//             'post_excerpt'   => __('Search Results','WCISPlugin'), //[ <string> ] // For all your post excerpt needs.
		...
		update_option( 'wcis_general_settings', $options );
	}
...
// 		}
	...
	function get_isp_search_box_form( $attr ) {   
	    ...
	    $form = '<form class="isp_search_box_form" isp_src="shortcode" name="isp_search_box" action="' . $action_url . '" style="width:'.$attr['width'].'rem; float:none;">';
        $form .=    '<input type="text" name="s" class="isp_search_box_input" placeholder="'.$attr['inner_text'].'" style="outline: none; width:'.$attr['width'].'rem; height:'.$attr['height'].'rem; font-size:'.$attr['text_size'].'em;">';
	...
	function wcis_serp_results_shortcode(){
        ...
        $url = 'https://acp-magento.appspot.com/wc_load_search_page?isp_platform=woocommerce';
